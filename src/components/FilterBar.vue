				...
				<div class="filter__col rooms">
					...
					<div class="rooms__wrapper">
						<input type="checkbox" id="rooms_1" class="rooms__checkbox">
							<label v-on:click="updateFilter('rooms', 1)" for="rooms_1" class="rooms__btn" v-bind:class="{'rooms__btn--active': filters.rooms === 1 }">1</label>
						<input type="checkbox" id="rooms_2" class="rooms__checkbox">
							<label v-on:click="updateFilter('rooms', 2)" for="rooms_2" class="rooms__btn rooms__btn" v-bind:class="{'rooms__btn--active': filters.rooms === 2 }">2</label>
						<input type="checkbox" id="rooms_3" class="rooms__checkbox">
							<label v-on:click="updateFilter('rooms', 3)" for="rooms_3" class="rooms__btn" v-bind:class="{'rooms__btn--active': filters.rooms === 3 }">3</label>
						<input type="checkbox" id="rooms_4" class="rooms__checkbox">
							<label v-on:click="updateFilter('rooms', 4)" for="rooms_4" class="rooms__btn" v-bind:class="{'rooms__btn--active': filters.rooms === 4 }">4</label>
					</div>
				</div>
				<div class="filter__col">
